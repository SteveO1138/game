...
class Trex {
  constructor() {
    ...
    this.el.style.backgroundImage= "url(https://img.itch.zone/aW1hZ2UvMTA4NjQ4LzUwNzA3NS5naWY=/original/4kbxMH.gif)"
    this.el.style.backgroundSize= "50px 50px"
...
class Foe {
  constructor() {
    ...
    this.el.style.height = getSize(this.height)
    this.el.style.width = getSize(this.width)
    this.el.style.backgroundColor = '#FF3333'
  }
...
class Stage {
  constructor(el) {
    ...
    this.el.style.backgroundImage = 'url(https://wallpaperplay.com/walls/full/4/d/2/76241.jpg)'
